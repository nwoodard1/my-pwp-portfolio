...
<div>
	...
	<ul>
		...
		<li><strong>Portfolio:</strong> I want this to be an animated, responsive image gallery containing 4-6 examples of my best work. Will have interactive and responsive pictures/animations reflecting my use of css/java script.

		<li><strong>Contact:</strong> This section will contain a simple contact form, my professional email address. Social Media Links: LinkedIn, Twitter, GitHub. Bootstrap links/icons at footer.
	</ul>
</div>
<div>
	<img src="pwpWireframe.png" alt="wireframe">
</div>
</body>
</html>